...
export function ContentPortfolioPage() {
  ...
  const gridClasses = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 sm:gap-5 grid-flow-row-dense sm:auto-rows-[220px] xl:auto-rows-[250px]";
