...
interface ContentCreateFormClientProps {
  mode?: FormMode;
}

export function ContentCreateFormClient({ mode = 'create' }: ContentCreateFormClientProps) {
                ...
                {!formData.url ? (
                  <div
                    ...
                    className={`w-full border-2 border-dashed rounded-lg p-8 text-center transition-colors cursor-pointer
                      ${isDraggingMain ? 'border-black bg-gray-50' : 'border-gray-300 hover:border-black'}
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <FormCheckbox
              ...
              onChange={(checked: any) => setFormData({ ...formData, hasContributors: checked })}
            />
          </div>
