...
│   │   │
│   │   ├── projects/
│   │   │   ├── page.tsx    # Previously: src/pages/ProjectsListPage.tsx
│   │   │   └── [slug]/     # ⚡ DYNAMIC ROUTE
│   │   │       └── page.tsx# Previously: src/pages/ProjectDetailPage.tsx (Fetches Supabase data & SEO)
│   │   │
│   │   ├── content/
│   │   │   ├── page.tsx    # Previously: src/pages/ContentPortfolioPage.tsx
│   │   │   └── [slug]/     # ⚡ DYNAMIC ROUTE
│   │   │       └── page.tsx# Previously: src/pages/ContentDetailPage.tsx
│   │   │
│   │   ├── blog/
